                            ...
                            <div className="mt-4 grid gap-2">
                                {sideLinks.map((link) => (
                                    <Link
                                        ...
                                        href={link.href}
                                        scroll={false}
                                        className={`rounded-2xl px-4 py-3 text-[14px] font-medium ${link.href.endsWith(slug)
                        ...
                        <section className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm md:p-9">
                            ...
                            <div className="mt-8 rounded-2xl border border-slate-200 bg-slate-50 p-5">
                                <p className="text-[14px] leading-7 text-slate-600">
                                    This content can later be connected to the admin dashboard, so
                                    the journal authority can update the page without changing the
                                    code.
                                </p>
                            </div>
                        </section>
