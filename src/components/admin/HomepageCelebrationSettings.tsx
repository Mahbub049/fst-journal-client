          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 max-w-3xl text-sm leading-6 text-white/70">
                Add a lightweight inauguration celebration across the public website.
                The effect never blocks clicks and automatically stops after the selected time.
              </p>
            </div>
          </div>
      ...
      <div className="space-y-6 p-6">
        <div>
          ...
          <p className="mt-1 text-xs leading-5 text-slate-500">
            These are intentionally elegant rather than loud, so the academic website still feels professional.
          </p>
        ...
        <div className="grid gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-4 lg:grid-cols-2">
          ...
          <div>
            ...
            >
              ...
              <option value="every-page">On every public page opened</option>
            </select>
            <p className="mt-1 text-xs text-slate-500">
        ...
        <div className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs leading-5 text-amber-900">
          Suggested inauguration setup: <strong>Launch Celebration</strong>, 8 seconds,
          once per browser session, with the same start/end period as the welcome modal.
